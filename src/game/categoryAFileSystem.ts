...
export const categoryAFiles: CategoryAFile[] = [
  ...
  },
  {
    ...
    content: [
      "[통신 버퍼 / 로컬 캐시]",
      "08:12:38 박진수 (엔지니어): 뭐야?",
      "08:12:40 이민아 (통신관): 무슨 일이야? 격리는 또 뭐고?",
      "08:12:42 최성현 (보안관): 우주 씨, 네 쪽도 문 잠겼어?",
  ...
  },
  {
    ...
    content: [
      ...
      "텍스트 파일 열람 시 #404_CORRUPTED 표시가 뜨면 파일 뷰어 상단의 [LOG_FIXER로 데이터 복구] 버튼을 클릭하세요.",
