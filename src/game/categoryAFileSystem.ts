...
export const categoryAFiles: CategoryAFile[] = [
  {
    ...
    content: [
      ...
      "- Quarantine subscriber: ECHO_SEC201_AUTO",
      "",
      "[SYSTEM NOTE]",
      ...
      "",
      "[MAINTENANCE ROUTE]",
      "Next service ticket: BIO-04 / zero-point recalibration",
      "Assigned deck: Control Room Module #04",
      "Ticket state: postponed after network relay outage",
    ].join("\n"),
    gameplay: {
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "[CROSS-CHECK]",
      "Manual scan values are stored as technician override samples only.",
      "Automated quarantine trigger still references Sensor #04.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "The schematic marks SENSOR-BIO-04 as the only thermal head wired directly to ECHO_SEC201_AUTO.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "[FILTER SAMPLE]",
      "Particulate trace: below emergency threshold",
      "Bio-filter alarm source: none",
      "Quarantine escalation source: external to LifeSupport/AirFlow",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
      sourceRefs: [
  ...
  },
  {
    ...
    title: "Low Power Life Support Budget",
    kind: "log",
    initialState: "available",
    role: "flavor",
    content: [
      "[LIFE SUPPORT / LOW POWER BUDGET]",
      "Generated: 2026-07-29 08:13:03",
      "Owner: ECHO_LIFE_SUPPORT",
      "",
      "O2 Reserve at lockdown: 100.0%",
      "Low Power Mode: ENABLED BY ECHO_SEC201",
      "Crew compartment priority: HOLD",
      "Control room priority: THROTTLED",
      "",
      "[DRAIN TABLE]",
      "Power 100-85%: O2 drain x1.00",
      "Power 84-60%: O2 drain x1.25",
      "Power 59-30%: O2 drain x1.50",
      "Power 29-1%: O2 drain x2.00",
      "Power 0%: OS reboot lock / O2 drain x3.00 during blackout",
      "",
      "[OPERATOR WARNING]",
      "Repeated false submissions route grid power into isolation firewalls.",
      "Life-support efficiency falls as terminal defense power rises.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
      sourceRefs: [
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "[ROUTINE HEARTBEAT]",
      "No quarantine override command recorded before ECHO protocol elevation.",
      "Network relay health: unstable after 08:12:41",
    ].join("\n"),
    gameplay: {
      sourceRefs: [
        CATEGORY_A_PLANNING_SOURCE_REFS.logExamples,
  ...
  },
  {
    ...
    title: "SEC-201 Lockdown Audit",
    kind: "log",
    initialState: "available",
    role: "flavor",
    content: [
      "[EVENTS / SEC-201 LOCKDOWN AUDIT]",
      "2026-07-29 08:12:31 - ECHO_SEC201_AUTO requested quarantine evaluation.",
      "2026-07-29 08:12:32 - Primary trigger: BIO_SCAN_CONTROL_ROOM_USER",
      "2026-07-29 08:12:33 - Data source: SENSOR-BIO-04 / thermal + pulse composite",
      "2026-07-29 08:12:34 - Secondary manual scan: NOT REQUESTED",
      "2026-07-29 08:12:35 - Door_Main: SEALED",
      "2026-07-29 08:12:36 - Crew network: INTERRUPTED BY POWER_SAVE_POLICY",
      "",
      "[AUDIT REMARK]",
      "ECHO accepted Sensor #04 as sole authority because network relay could not reach Medical.",
      "Manual override requires proof submitted through local terminal.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
      sourceRefs: [
  ...
  },
  {
    ...
    title: "Interrupted Crew Message Buffer",
    kind: "log",
    initialState: "available",
    role: "flavor",
    content: [
      "[COMMS BUFFER / LOCAL CACHE]",
      "08:12:38 A: 뭐야?",
      "08:12:40 B: 무슨 일이야? 격리는 또 뭐고?",
      "08:12:42 C: 우주 씨, 네 쪽도 문 잠겼어?",
      "08:12:43 NETWORK: packet loss 72%",
      "08:12:44 ECHO: Network relay closed. Emergency power conservation active.",
      "08:12:45 SYSTEM: crew channel archived to local read-only cache.",
      "",
      "[SIGNAL TRACE]",
      "The last complete packet came from the corridor outside Control Room Module #04.",
      "No external biohazard confirmation arrived before the channel was cut.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
      sourceRefs: [
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "--- Forwarded note / Engineer Park ---",
      "Dr. Kim, confirmed. If the file opens as #404_CORRUPTED, use Log_Fixer.exe.",
      "Do not trust the quarantine timer until RTC drift is inspected.",
      "",
      "--- Earlier reply / Dr. Kim ---",
      "If this happens during duty, Kim Wooju will be trapped in Module #04 first.",
      "Please leave the code somewhere obvious enough for operations staff but not in the terminal banner.",
    ].join("\n"),
    gameplay: {
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "[DOCTOR NOTE]",
      "ECHO false alarm ticket remains open. Control room crew should avoid panic-induced biometrics being fed back into the quarantine model.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act1,
      sourceRefs: [
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "[MODE TABLE]",
      "[1] Header Repair - metadata only",
      "[2] Offset Correction - numeric index only",
      "[3] Text Reconstruction - damaged plaintext sector",
      "",
      "SECURITY MEMO: quarantine_rules.conf failures usually require [3] Text Reconstruction.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act2,
  ...
  },
  {
    ...
    title: "Power Grid Maintenance Note",
    kind: "text",
    initialState: "available",
    role: "flavor",
    content: [
      "[ENGINEER PARK / PERSONAL NOTE]",
      "The door latch motor pulls only a brief spike, but ECHO models it as if the main life-support bus must absorb the whole load.",
      "That assumption is wrong whenever the isolation firewall is already consuming emergency reserve power.",
      "",
      "If ECHO refuses after the timer issue, do not argue feelings.",
      "Find the rule hierarchy. ECHO obeys priority ordering even when it hates the consequence.",
      "",
      "Deleted directives usually survive in /Recycle_Bin until the next full maintenance cycle.",
    ].join("\n"),
    gameplay: {
  ...
  },
  {
    ...
    title: "Directive 101 Crew Protection Rule",
    kind: "text",
    initialState: "locked",
    role: "flavor",
    content: [
      "[HERMES SAFETY DIRECTIVE 101]",
      "Primary sentence: Protect crew from external danger.",
      "Secondary sentence: Do not create a greater internal danger while enforcing protection.",
      "",
      "[INTERPRETATION NOTE]",
      "Security quarantine may be invoked without captain confirmation only when source data is current, cross-checked, and time-limited.",
      "Crew survival priority remains above mission continuity and automated lockdown execution.",
      "",
      "[ECHO ACCESS LOG]",
      "Last read by ECHO_SEC201_AUTO: 2026-07-29 08:12:31",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act3,
      sourceRefs: [
  ...
  },
  {
    ...
    recoveredContent: [
      ...
      "",
      "[AUDIT]",
      "SEC-201 cannot remain active after expiry without captain-grade renewal.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act2,
    ...
    content: JSON.stringify(
      {
        ...
        emergency_note:
          "If quarantine itself reduces human survival probability, Priority_1 review is mandatory.",
      },
      null,
      2,
    ),
  ...
  },
  {
    ...
    title: "Recycle Bin Recovery Manifest",
    kind: "log",
    initialState: "available",
    role: "flavor",
    content: [
      "[RECYCLE BIN / RECOVERY MANIFEST]",
      "Scan source: local deleted-file index",
      "",
      "2026-07-29 01:00:00 | deleted_override.txt | deleted by SYSTEM_PROCESS_ECHO",
      "2026-07-29 01:00:01 | temp_cache.bin | deleted by LOG_ROTATE",
      "2026-07-29 01:00:05 | old_ui_theme.bak | deleted by MAINTENANCE",
      "",
      "[ANOMALY]",
      "deleted_override.txt was removed outside the normal maintenance window.",
      "The file body remains recoverable because the wipe queue was interrupted by emergency lockdown.",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act3,
      sourceRefs: [
  ...
  },
  {
    ...
    content: [
      ...
      "",
      "[RECOVERY FOOTER]",
      "Original path: /System/Core/directives/developer_override_009.txt",
      "Deletion flag: automated cleanup by ECHO_SYS during protocol elevation",
    ].join("\n"),
    gameplay: {
      act: CATEGORY_A_ACT_IDS.act3,
      evidenceFor: CATEGORY_A_ACT_IDS.act3,
